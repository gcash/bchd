...
var file_bchrpc_proto_rawDesc = []byte{
	...
	0x44, 0x5f, 0x53, 0x45, 0x4e, 0x44, 0x10, 0x0b, 0x32, 0x80, 0x0c, 0x0a, 0x06, 0x62, 0x63, 0x68,
	...
	0x72, 0x6f, 0x6f, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x52,
	...
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x30, 0x01, 0x32, 0xf0, 0x02, 0x0a, 0x06,
	0x73, 0x6c, 0x70, 0x72, 0x70, 0x63, 0x12, 0x4f, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x6b,
	...
	0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x53, 0x6c, 0x70, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x30,
...
var file_bchrpc_proto_depIdxs = []int32{
	...
	36, // 77: pb.bchrpc.SubmitTransaction:input_type -> pb.SubmitTransactionRequest
	40, // 78: pb.bchrpc.SubscribeTransactions:input_type -> pb.SubscribeTransactionsRequest
	40, // 79: pb.bchrpc.SubscribeTransactionStream:input_type -> pb.SubscribeTransactionsRequest
	41, // 80: pb.bchrpc.SubscribeBlocks:input_type -> pb.SubscribeBlocksRequest
	42, // 81: pb.slprpc.GetTokenMetadata:input_type -> pb.GetTokenMetadataRequest
	44, // 82: pb.slprpc.GetParsedSlpScript:input_type -> pb.GetParsedSlpScriptRequest
	46, // 83: pb.slprpc.GetTrustedSlpValidation:input_type -> pb.GetTrustedSlpValidationRequest
	38, // 84: pb.slprpc.CheckSlpTransaction:input_type -> pb.CheckSlpTransactionRequest
	...
	37, // 100: pb.bchrpc.SubmitTransaction:output_type -> pb.SubmitTransactionResponse
	49, // 101: pb.bchrpc.SubscribeTransactions:output_type -> pb.TransactionNotification
	49, // 102: pb.bchrpc.SubscribeTransactionStream:output_type -> pb.TransactionNotification
	48, // 103: pb.bchrpc.SubscribeBlocks:output_type -> pb.BlockNotification
	43, // 104: pb.slprpc.GetTokenMetadata:output_type -> pb.GetTokenMetadataResponse
	45, // 105: pb.slprpc.GetParsedSlpScript:output_type -> pb.GetParsedSlpScriptResponse
	47, // 106: pb.slprpc.GetTrustedSlpValidation:output_type -> pb.GetTrustedSlpValidationResponse
	39, // 107: pb.slprpc.CheckSlpTransaction:output_type -> pb.CheckSlpTransactionResponse
...
// SlprpcClient is the client API for Slprpc service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type SlprpcClient interface {
...
type slprpcClient struct {
	cc grpc.ClientConnInterface
}

func NewSlprpcClient(cc grpc.ClientConnInterface) SlprpcClient {
	return &slprpcClient{cc}
}

func (c *slprpcClient) GetTokenMetadata(ctx context.Context, in *GetTokenMetadataRequest, opts ...grpc.CallOption) (*GetTokenMetadataResponse, error) {
	out := new(GetTokenMetadataResponse)
	err := c.cc.Invoke(ctx, "/pb.slprpc/GetTokenMetadata", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slprpcClient) GetParsedSlpScript(ctx context.Context, in *GetParsedSlpScriptRequest, opts ...grpc.CallOption) (*GetParsedSlpScriptResponse, error) {
	out := new(GetParsedSlpScriptResponse)
	err := c.cc.Invoke(ctx, "/pb.slprpc/GetParsedSlpScript", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slprpcClient) GetTrustedSlpValidation(ctx context.Context, in *GetTrustedSlpValidationRequest, opts ...grpc.CallOption) (*GetTrustedSlpValidationResponse, error) {
	out := new(GetTrustedSlpValidationResponse)
	err := c.cc.Invoke(ctx, "/pb.slprpc/GetTrustedSlpValidation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *slprpcClient) CheckSlpTransaction(ctx context.Context, in *CheckSlpTransactionRequest, opts ...grpc.CallOption) (*CheckSlpTransactionResponse, error) {
	out := new(CheckSlpTransactionResponse)
	err := c.cc.Invoke(ctx, "/pb.slprpc/CheckSlpTransaction", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// SlprpcServer is the server API for Slprpc service.
type SlprpcServer interface {
	// GetTokenMetadata return SLP token metadata for one or more tokens.
	//
	// **Requires SlpIndex**
...
// UnimplementedSlprpcServer can be embedded to have forward compatible implementations.
type UnimplementedSlprpcServer struct {
}

func (*UnimplementedSlprpcServer) GetTokenMetadata(context.Context, *GetTokenMetadataRequest) (*GetTokenMetadataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTokenMetadata not implemented")
}
func (*UnimplementedSlprpcServer) GetParsedSlpScript(context.Context, *GetParsedSlpScriptRequest) (*GetParsedSlpScriptResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetParsedSlpScript not implemented")
}
func (*UnimplementedSlprpcServer) GetTrustedSlpValidation(context.Context, *GetTrustedSlpValidationRequest) (*GetTrustedSlpValidationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTrustedSlpValidation not implemented")
}
func (*UnimplementedSlprpcServer) CheckSlpTransaction(context.Context, *CheckSlpTransactionRequest) (*CheckSlpTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckSlpTransaction not implemented")
}

func RegisterSlprpcServer(s *grpc.Server, srv SlprpcServer) {
	s.RegisterService(&_Slprpc_serviceDesc, srv)
}

func _Slprpc_GetTokenMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTokenMetadataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SlprpcServer).GetTokenMetadata(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.slprpc/GetTokenMetadata",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlprpcServer).GetTokenMetadata(ctx, req.(*GetTokenMetadataRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Slprpc_GetParsedSlpScript_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetParsedSlpScriptRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SlprpcServer).GetParsedSlpScript(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.slprpc/GetParsedSlpScript",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlprpcServer).GetParsedSlpScript(ctx, req.(*GetParsedSlpScriptRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Slprpc_GetTrustedSlpValidation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTrustedSlpValidationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SlprpcServer).GetTrustedSlpValidation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.slprpc/GetTrustedSlpValidation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlprpcServer).GetTrustedSlpValidation(ctx, req.(*GetTrustedSlpValidationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Slprpc_CheckSlpTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckSlpTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SlprpcServer).CheckSlpTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.slprpc/CheckSlpTransaction",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SlprpcServer).CheckSlpTransaction(ctx, req.(*CheckSlpTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Slprpc_serviceDesc = grpc.ServiceDesc{
	ServiceName: "pb.slprpc",
	HandlerType: (*SlprpcServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetTokenMetadata",
			Handler:    _Slprpc_GetTokenMetadata_Handler,
		},
		{
			MethodName: "GetParsedSlpScript",
			Handler:    _Slprpc_GetParsedSlpScript_Handler,
		},
		{
			MethodName: "GetTrustedSlpValidation",
			Handler:    _Slprpc_GetTrustedSlpValidation_Handler,
		},
		{
			MethodName: "CheckSlpTransaction",
			Handler:    _Slprpc_CheckSlpTransaction_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "bchrpc.proto",
