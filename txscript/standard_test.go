...
func TestGetScriptClass(t *testing.T) {
	txhex, _ := hex.DecodeString("")

	tx := wire.MsgTx{}
	tx.BchDecode(bytes.NewReader(txhex), wire.ProtocolVersion, wire.BaseEncoding)

	addr, err := bchutil.DecodeAddress("pqkqrd9sg4svdftuczmezpwae3qy967qqch2adqfe2", &chaincfg.TestNet3Params)
	if err != nil {
		t.Fatal(err)
	}
	...
	// e80300000000008017a9142c01b4b04560c6a57cc0b79105ddcc4042ebc00687
	//                   a9142c01b4b04560c6a57cc0b79105ddcc4042ebc00687
	var buf bytes.Buffer
	wire.WriteTxOut(&buf, 0, 0, tx.TxOut[0])
	fmt.Println(hex.EncodeToString(buf.Bytes()))

	r, _ := hex.DecodeString("e80300000000000017a9142c01b4b04560c6a57cc0b79105ddcc4042ebc00687")
	a := chainhash.DoubleHashH(r)
	fmt.Println(a.String())

	fmt.Println(calcHashOutputs(&tx).String())

	vm, err := NewEngine(scriptPubkey, &tx, 0, StandardVerifyFlags, nil, nil, 2000)
	if err != nil {
		t.Fatal(err)
	}
